...
public class SimpleMonster {
    protected /*final (changed to protected and removed final)*/ String name, type, strongAgainst, weakAgainst;
    protected /*changed to protected*/int maxHP, hp, atk, def, xp, lvl;
    protected /*changed to protected*/static ArrayList<SimpleMonster> monsterList = new ArrayList<>();
